          ...
          WidgetbookUseCase(
            ...
            builder: (context) {
              final tokens = <String, Color>{
                ...
                'statusSuccessContrast': AlterSemanticTokens.statusSuccessContrast,
                'statusTeal': AlterSemanticTokens.statusTeal,
                'statusTealContrast': AlterSemanticTokens.statusTealContrast,
                'statusCaution': AlterSemanticTokens.statusCaution,
                'statusCautionContrast': AlterSemanticTokens.statusCautionContrast,
                'statusWarning': AlterSemanticTokens.statusWarning,
                'statusWarningContrast': AlterSemanticTokens.statusWarningContrast,
                'statusDanger': AlterSemanticTokens.statusDanger,
                'statusDangerContrast': AlterSemanticTokens.statusDangerContrast,
